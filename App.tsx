    ...
    <div className="max-w-5xl mx-auto p-2 sm:p-4 text-slate-300 text-xs selection:bg-blue-500/30 no-scrollbar">
      <header className="mb-4 flex flex-col sm:flex-row items-center justify-between gap-4 border-b border-slate-800 pb-4">
        <div className="flex items-center gap-4">
          ...
          <button 
            onClick={handleReset}
            className="px-3 py-1 bg-slate-800/50 hover:bg-rose-900/20 text-slate-500 hover:text-rose-400 border border-slate-700/50 rounded text-[9px] font-black uppercase tracking-widest transition-all"
          >
            Reset
          </button>
        </div>
